...
describe('Validate JS configs', () => {
  it('Validate eslint-config-ants', async () => {
  ...
  it('Validate eslint-config-ants/es5', async () => {
  ...
  it('Validate eslint-config-ants/vue', async () => {
  ...
  it('Validate eslint-config-ants/essential', async () => {
  ...
  it('Validate eslint-config-ants/essential/es5', async () => {
  ...
  it('Validate eslint-config-ants/essential/react', async () => {
  ...
  it('Validate eslint-config-ants/essential/vue', async () => {
  ...
  it('Validate eslint-config-ants/node', async () => {
