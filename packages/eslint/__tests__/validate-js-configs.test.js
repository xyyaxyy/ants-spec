...
describe('Validate JS configs', () => {
  it('Validate ants-spec-eslint', async () => {
  ...
  it('Validate ants-spec-eslint/es5', async () => {
  ...
  it('Validate ants-spec-eslint/vue', async () => {
  ...
  it('Validate ants-spec-eslint/essential', async () => {
  ...
  it('Validate ants-spec-eslint/essential/es5', async () => {
  ...
  it('Validate ants-spec-eslint/essential/react', async () => {
  ...
  it('Validate ants-spec-eslint/essential/vue', async () => {
  ...
  it('Validate ants-spec-eslint/node', async () => {
